...
<body>
    ...
    <div class="formtitle"><span>修改读者信息</span></div>
	    <form action="updByReaderId" method="post" id="fm" target="_top">
	    	<input  type="hidden" name="oper" value="pwd" />
		    <ul class="forminfo">
		    <li><label>读者ID</label><input name="id" id="id" type="text" class="dfinput" /><i></i></li>
