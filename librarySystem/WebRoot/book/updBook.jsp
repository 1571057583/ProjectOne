...
<script type="text/javascript">
	$(function(){
		//校验密码修改
		$("#fm").submit(function(){
			if($("#id").val()==""||$("#bookeName").val()=="" ||$("#publisherTime").val()==""||$("#publisher").val()==""||$("#profession").val()==""||$("#price").val()==""||$("#authorName").val()=="" ){//校验填空
				alert("信息不能为空,请重新填写");
				return false;
			}else{	
				alert("修改成功");			
...
<body>
    ...
    <div class="formtitle"><span>修改图书信息</span></div>
	    <form action="udpById" method="post" id="fm" target="_top">
